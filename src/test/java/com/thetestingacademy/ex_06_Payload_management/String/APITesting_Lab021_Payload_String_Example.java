package com.thetestingacademy.ex_06_Payload_management.String;
...
public class APITesting_Lab021_Payload_String_Example {
    ...
    public void test_POST() {
        ...
        Assert.assertEquals(firstname,"Brown");
        ...
        assertThat(firstname).isEqualTo("Brown").isNotBlank().isNotEmpty().isNotNull().isAlphanumeric();
